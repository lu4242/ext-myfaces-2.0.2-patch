...
public final class ResourceBundleResolver extends ELResolver
{
    ...
    public Iterator<FeatureDescriptor> getFeatureDescriptors(final ELContext context, final Object base)
    {
        ...
        final Map<String,org.apache.myfaces.ov2021.config.element.ResourceBundle> resourceBundles =
                runtimeConfig(context).getResourceBundles();

        for (org.apache.myfaces.ov2021.config.element.ResourceBundle resourceBundle : resourceBundles.values())
        {
    ...
    private static FeatureDescriptor makeDescriptor(
                                                   org.apache.myfaces.ov2021.config.element.ResourceBundle bundle)
    {
