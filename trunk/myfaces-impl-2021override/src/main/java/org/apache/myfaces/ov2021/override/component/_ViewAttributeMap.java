...
class _ViewAttributeMap implements Map<String, Object>, Serializable
{
    ...
    private UIViewRootFix _root;

    public _ViewAttributeMap(UIViewRootFix root, Map<String, Object> delegate)
    {
    ...
    public Object get(Object key)
    {
        ...
        {
            return _root.getStateHelper().get(UIViewRootFix.PropertyKeys.uniqueIdCounter);
        }
    ...
    public Object put(String key, Object value)
    {
        ...
        if (UNIQUE_ID_COUNTER_KEY.length() == keyLength
            && UNIQUE_ID_COUNTER_KEY.equals(key))
        {
            Long v = (Long) _root.getStateHelper().get(UIViewRootFix.PropertyKeys.uniqueIdCounter);
            _root.getStateHelper().put(UIViewRootFix.PropertyKeys.uniqueIdCounter, value);
            return v;
        }
