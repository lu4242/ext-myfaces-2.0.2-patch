...
public abstract class MyfacesResponseStateManager extends ResponseStateManager
{
    ...
    /**
     * Writes url parameters with the state info to be saved. {@link org.apache.myfaces.ov2021.application.MyfacesStateManager}
     * delegates calls to {@link org.apache.myfaces.ov2021.application.MyfacesStateManager#writeState} to this method.
     * 
     * @deprecated
     */
    @Deprecated
