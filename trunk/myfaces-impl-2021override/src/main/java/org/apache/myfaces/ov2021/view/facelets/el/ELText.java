 ...
 * under the License.
 */
package org.apache.myfaces.ov2021.view.facelets.el;
 ...
 * 
 * @author Jacob Hookom
 * @version $Id: ELText.java 1351627 2012-06-19 09:50:21Z lu4242 $
 */
public class ELText
{
    ...
    private static final class ELCacheableTextVariable extends ELText
    {
        ...
        public ELCacheableTextVariable(ValueExpression ve)
        {
            ...
            this.capabilities = (compositeComponentExpression ? EL_CC : 0);
        }
     ...
     * treated as {@link org.apache.myfaces.ov2021.view.facelets.el.LiteralValueExpression LiteralValueExpressions}.
     * 
     * @param in
     *            String to parse
