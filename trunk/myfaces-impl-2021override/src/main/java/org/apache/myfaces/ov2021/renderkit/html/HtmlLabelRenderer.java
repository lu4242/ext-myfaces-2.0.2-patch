...
import org.apache.myfaces.shared_ext202patch.component.EscapeCapable;
import org.apache.myfaces.shared_ext202patch.renderkit.JSFAttr;
import org.apache.myfaces.shared_ext202patch.renderkit.RendererUtils;
import org.apache.myfaces.shared_ext202patch.renderkit.html.CommonEventUtils;
import org.apache.myfaces.shared_ext202patch.renderkit.html.CommonPropertyUtils;
import org.apache.myfaces.shared_ext202patch.renderkit.html.HTML;
import org.apache.myfaces.shared_ext202patch.renderkit.html.HtmlRenderer;
import org.apache.myfaces.shared_ext202patch.renderkit.html.HtmlRendererUtils;
import org.apache.myfaces.shared_ext202patch.renderkit.html.util.JavascriptUtils;
            ...
            if (text != null)
            {
                ...
                else
                {
                    escape = RendererUtils.getBooleanAttribute(uiComponent,
                                                               org.apache.myfaces.shared_ext202patch.renderkit.JSFAttr.ESCAPE_ATTR,
                                                               true); //default is to escape
                }                
                if (escape)
                {
                    writer.writeText(text, org.apache.myfaces.shared_ext202patch.renderkit.JSFAttr.VALUE_ATTR);
                }
                else
                {
                    writer.write(text);
