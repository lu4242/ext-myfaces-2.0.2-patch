 ...
 * @version $Revision: 1569181 $ $Date: 2014-02-18 05:14:07 +0100 (Di, 18 Feb 2014) $
 */
...
public abstract class UIComponentBaseNCFix extends UIComponentNCFix
{
    //private static Log log = LogFactory.getLog(UIComponentBase.class);
    private static Logger log = Logger.getLogger(UIComponentBaseNCFix.class.getName());
