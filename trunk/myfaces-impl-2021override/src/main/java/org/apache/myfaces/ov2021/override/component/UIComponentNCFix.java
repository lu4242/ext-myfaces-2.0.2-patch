...
public abstract class UIComponentNCFix extends UINamingContainer implements PartialStateHolder, SystemEventListenerHolder, ComponentSystemEventListener {
            ...
            else
            {
                ...
                else if ((listenerCapability & LISTENER_TYPE_RENDERER) != 0)
                {
                    listener = (ComponentSystemEventListener)
                            ((UIComponentNCFix)UIComponent.getCurrentComponent(context)).getRenderer(context);
                }
                else
                {
                    listener = (ComponentSystemEventListener)
