...
public abstract class FacesConfigData implements Serializable
{
    ...
    /**
     * @return Iterator over {@linkorg.apache.myfaces.ov2021.config.element.ManagedBean ManagedBean}s
     */
    public abstract Collection<ManagedBean> getManagedBeans();

    /**
     * @return Iterator over {@linkorg.apache.myfaces.ov2021.config.element.NavigationRule NavigationRule}s
     */
    ...
    /**
     * @return Iterator over {@linkorg.apache.myfaces.ov2021.config.element.Renderer Renderer}s for the given renderKitId
     */
