 ...
 * @version $Revision: 1301672 $ $Date: 2012-03-16 19:00:42 +0100 (Fr, 16 Mär 2012) $
 * @since 2.0.1
 */
public abstract class AbstractFacelet extends Facelet
{
     ...
     * 
     * @see org.apache.myfaces.ov2021.view.facelets.impl.DefaultFaceletFactory#getFacelet(URL)
     * @param ctx
     *            FaceletContext to pass to the included Facelet
     * @param parent
     *            UIComponent to apply changes to
