 ...
 * @version $Revision: 1534236 $ $Date: 2013-10-21 10:47:09 -0500 (Mo, 21 Okt 2013) $
 */
class _ComponentAttributesMap implements Map<String, Object>, Serializable
{
    ...
    private UIComponentBaseNCFix _component;
     ...
     */
    _ComponentAttributesMap(UIComponentBaseNCFix component)
    {
    ...
    public boolean containsKey(Object key)
    {
        ...
        if (keyLength >= MIN_LENGHT_CHECK)
        {
            ...
            {
                return ((UIComponentBaseNCFix)_component).getOamVfMarkCreated() != null;
            }
    ...
    public Object remove(Object key)
    {
        ...
        return _component.getStateHelper().remove(
                UIComponentBaseNCFix.PropertyKeys.attributesMap, key);
    }
    ...
    public Object put(String key, Object value)
    {
        ...
        return _component.getStateHelper().put(UIComponentBaseNCFix.PropertyKeys.attributesMap, key, value);
    }
     ...
     * <p/>
     * This method is package-scope so that the UIComponentBaseFix class can access it
    ...
    Map<String, Object> getUnderlyingMap()
    {
        ...
        if (stateHelper != null)
        {
            attributes = (Map<String, Object>) stateHelper.get(UIComponentBaseNCFix.PropertyKeys.attributesMap);
        }
