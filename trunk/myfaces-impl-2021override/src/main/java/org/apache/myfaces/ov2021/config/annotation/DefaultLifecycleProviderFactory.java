                ...
                returnValue = AccessController.doPrivileged(new java.security.PrivilegedExceptionAction<Boolean>()
                        {
                                    ...
                                    PrivilegedActionException
                            {
                                ...
                                while (iter.hasNext())
                                {
                                    ...
                                    if (className.startsWith("org.apache.myfaces.config.annotation."))
                                    {
                                        className = className.replace("org.apache.myfaces.config.annotation.", 
                                                "org.apache.myfaces.ov2021.config.annotation.");
                                    }
