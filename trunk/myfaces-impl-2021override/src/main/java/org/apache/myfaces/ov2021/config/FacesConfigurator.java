...
import org.apache.myfaces.ov2021.application.ApplicationFactoryImpl;
import org.apache.myfaces.ov2021.application.BackwardsCompatibleNavigationHandlerWrapper;
import org.apache.myfaces.ov2021.component.visit.VisitContextFactoryImpl;
import org.apache.myfaces.ov2021.config.annotation.AnnotationConfigurator;
import org.apache.myfaces.ov2021.config.annotation.LifecycleProviderFactory;
...
import org.apache.myfaces.ov2021.config.element.FacesConfig;
...
import org.apache.myfaces.ov2021.config.impl.digester.DigesterFacesConfigDispenserImpl;
import org.apache.myfaces.ov2021.config.impl.digester.DigesterFacesConfigUnmarshallerImpl;
import org.apache.myfaces.ov2021.context.ExceptionHandlerFactoryImpl;
import org.apache.myfaces.ov2021.context.ExternalContextFactoryImpl;
import org.apache.myfaces.ov2021.context.FacesContextFactoryImpl;
import org.apache.myfaces.ov2021.context.PartialViewContextFactoryImpl;
import org.apache.myfaces.ov2021.el.DefaultPropertyResolver;
import org.apache.myfaces.ov2021.el.VariableResolverImpl;
import org.apache.myfaces.ov2021.el.unified.ResolverBuilderBase;
import org.apache.myfaces.ov2021.lifecycle.LifecycleFactoryImpl;
import org.apache.myfaces.ov2021.renderkit.RenderKitFactoryImpl;
import org.apache.myfaces.ov2021.renderkit.html.HtmlRenderKitImpl;
...
import org.apache.myfaces.shared_ext202patch.util.LocaleUtils;
import org.apache.myfaces.shared_ext202patch.util.StateUtils;
import org.apache.myfaces.shared_impl.util.serial.DefaultSerialFactory;
import org.apache.myfaces.shared_impl.util.serial.SerialFactory;
import org.apache.myfaces.ov2021.spi.FacesConfigurationMerger;
import org.apache.myfaces.ov2021.spi.FacesConfigurationMergerFactory;
import org.apache.myfaces.ov2021.util.ContainerUtils;
import org.apache.myfaces.ov2021.util.ExternalSpecifications;
import org.apache.myfaces.ov2021.view.ViewDeclarationLanguageFactoryImpl;
import org.apache.myfaces.ov2021.view.facelets.tag.jsf.TagHandlerDelegateFactoryImpl;
import org.apache.myfaces.ov2021.view.facelets.tag.ui.DebugPhaseListener;
 ...
 * @version $Revision: 1518437 $ $Date: 2013-08-29 02:59:38 +0200 (Do, 29 Aug 2013) $
 */
