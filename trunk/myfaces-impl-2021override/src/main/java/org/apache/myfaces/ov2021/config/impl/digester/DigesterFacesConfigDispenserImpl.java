...
import org.apache.myfaces.ov2021.config.FacesConfigDispenser;
...
import org.apache.myfaces.ov2021.config.element.Application;
import org.apache.myfaces.ov2021.config.element.Converter;
import org.apache.myfaces.ov2021.config.element.FacesConfig;
import org.apache.myfaces.ov2021.config.element.Factory;
import org.apache.myfaces.ov2021.config.element.LocaleConfig;
import org.apache.myfaces.ov2021.config.element.NamedEvent;
import org.apache.myfaces.ov2021.config.element.RenderKit;
...
public class DigesterFacesConfigDispenserImpl extends FacesConfigDispenser
{
    ...
    private Map<String,org.apache.myfaces.ov2021.config.impl.digester.elements.RenderKit> renderKits = new LinkedHashMap<String,org.apache.myfaces.ov2021.config.impl.digester.elements.RenderKit>();
    ...
    public void feed(FacesConfig config)
    {
        ...
        for (RenderKit renderKit : config.getRenderKits())
        {
           ...
           org.apache.myfaces.ov2021.config.impl.digester.elements.RenderKit existing = renderKits.get(renderKitId);

            if (existing == null)
            {
                existing = new org.apache.myfaces.ov2021.config.impl.digester.elements.RenderKit();
    ...
    /**
     * @return Collection over {@linkorg.apache.myfaces.ov2021.config.element.ManagedBean ManagedBean}s
     */
    ...
    /**
     * @return Collection over {@linkorg.apache.myfaces.ov2021.config.element.NavigationRule NavigationRule}s
     */
    ...
    /**
     * @return Iterator over {@linkorg.apache.myfaces.ov2021.config.element.ClientBehaviorRenderer ClientBehaviorRenderer}s for the given renderKitId
     */
    ...
    /**
     * @return Collection over {@linkorg.apache.myfaces.ov2021.config.element.Renderer Renderer}s for the given renderKitId
     */
