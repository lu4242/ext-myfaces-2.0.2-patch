...
public class UIViewRootFix extends UIViewRoot implements UniqueIdVendor
{
    ...
    private Logger _getLogger()
    {
        if (logger == null)
        {
            logger = Logger.getLogger(UIViewRootFix.class.getName());
        }
        return logger;
    }
    ...
    {
        public void process(FacesContext context, UIViewRootFix root);
    }
