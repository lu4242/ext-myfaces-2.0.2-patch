...
import org.apache.myfaces.ov2021.view.facelets.tag.jsf.PreDisposeViewEvent;
import org.apache.myfaces.shared_ext202patch.application.NavigationUtils;
import org.apache.myfaces.shared_ext202patch.renderkit.html.util.SharedStringBuilder;
import org.apache.myfaces.shared_ext202patch.util.HashMapUtils;
import org.apache.myfaces.shared_ext202patch.util.StringUtils;

/**
 * @author Thomas Spiegl (latest modification by $Author: lu4242 $)
 * @author Anton Koinov
 * @version $Revision: 1518454 $ $Date: 2013-08-29 04:49:15 +0200 (Do, 29 Aug 2013) $
 */
    ...
    */
    ...
    private NavigationCase getOutcomeNavigationCase (FacesContext facesContext, String fromAction, String outcome)
    {
        ...
        if (implicitViewId != null)
        {
            ...
            result = new org.apache.myfaces.ov2021.override.application.NavigationCase (viewId, fromAction, outcome, null, 
    ...
    {
        Collection<? extends org.apache.myfaces.ov2021.config.element.NavigationCase> configCases = rule.getNavigationCases();
        Set<NavigationCase> apiCases = new HashSet<NavigationCase>(configCases.size());
        
        for(org.apache.myfaces.ov2021.config.element.NavigationCase configCase : configCases)
        {   
            if(configCase.getRedirect() != null)
            {
                ...
                apiCases.add(new org.apache.myfaces.ov2021.override.application.NavigationCase(rule.getFromViewId(),configCase.getFromAction(),
