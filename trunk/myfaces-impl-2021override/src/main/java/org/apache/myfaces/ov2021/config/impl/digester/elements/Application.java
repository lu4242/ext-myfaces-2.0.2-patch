 ...
 */
public class Application extends org.apache.myfaces.ov2021.config.element.Application implements Serializable
{
    ...
    private final List<org.apache.myfaces.ov2021.config.element.LocaleConfig> localeConfig = new ArrayList<org.apache.myfaces.ov2021.config.element.LocaleConfig>();
    private final List<String> elResolver = new ArrayList<String>();
    private final List<org.apache.myfaces.ov2021.config.element.ResourceBundle> resourceBundle = new ArrayList<org.apache.myfaces.ov2021.config.element.ResourceBundle>();
    private final List<org.apache.myfaces.ov2021.config.element.SystemEventListener> systemEventListeners = new ArrayList<org.apache.myfaces.ov2021.config.element.SystemEventListener>();
    ...
    public void addSystemEventListener (org.apache.myfaces.ov2021.config.element.SystemEventListener systemEventListener)
    {
    ...
    public void addLocaleConfig(org.apache.myfaces.ov2021.config.element.LocaleConfig config)
    {
    ...
    public void addResourceBundle(org.apache.myfaces.ov2021.config.element.ResourceBundle bundle)
    {
    ...
    public List<org.apache.myfaces.ov2021.config.element.SystemEventListener> getSystemEventListeners ()
    {
    ...
    public List<org.apache.myfaces.ov2021.config.element.LocaleConfig> getLocaleConfig()
    {
        return localeConfig;
    }
    ...
    public List<org.apache.myfaces.ov2021.config.element.ResourceBundle> getResourceBundle()
    {
