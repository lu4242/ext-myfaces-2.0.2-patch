 ...
 * under the License.
 */
package org.apache.myfaces.ov2021.config.annotation;
...
import org.apache.myfaces.ov2021.config.impl.digester.elements.Application;
import org.apache.myfaces.ov2021.config.impl.digester.elements.Behavior;
import org.apache.myfaces.ov2021.config.impl.digester.elements.Converter;
import org.apache.myfaces.ov2021.config.impl.digester.elements.FacesConfig;
import org.apache.myfaces.ov2021.spi.AnnotationProvider;
import org.apache.myfaces.ov2021.spi.AnnotationProviderFactory;
 ...
 * @version $Revision: 1455393 $ $Date: 2013-03-12 03:17:52 +0100 (Di, 12 Mär 2013) $
 */
        ...
        if (classes != null && !classes.isEmpty())
        {
            for (Class<?> clazz : classes)
            {
                ...
                if (rend != null)
                {
                   ...
                   org.apache.myfaces.ov2021.config.impl.digester.elements.RenderKit renderKit =
                       (org.apache.myfaces.ov2021.config.impl.digester.elements.RenderKit) facesConfig.getRenderKit(renderKitId);
                    if (renderKit == null)
                    {
                        renderKit = new org.apache.myfaces.ov2021.config.impl.digester.elements.RenderKit();
                        renderKit.setId(renderKitId);
                        facesConfig.addRenderKit(renderKit);
                    }
                    
                   org.apache.myfaces.ov2021.config.impl.digester.elements.Renderer renderer =
                        new org.apache.myfaces.ov2021.config.impl.digester.elements.Renderer();
        ...
        if (classes != null && !classes.isEmpty())
        {
            for (Class<?> clazz : classes)
            {
                ...
                if (bean != null)
                {
                   ...
                   org.apache.myfaces.ov2021.config.impl.digester.elements.ManagedBean mbc =
                        new org.apache.myfaces.ov2021.config.impl.digester.elements.ManagedBean();
                    ...
                    for (Field field : fields)
                    {
                        ...
                        if (property != null)
                        {
                           ...
                           org.apache.myfaces.ov2021.config.impl.digester.elements.ManagedProperty mpc = 
                                new org.apache.myfaces.ov2021.config.impl.digester.elements.ManagedProperty();
        ...
        if (classes != null && !classes.isEmpty())
        {
            for (Class<?> clazz : classes)
            {
                ...
                if (namedEvent != null) {
                    ...
                    // singleton).
                   org.apache.myfaces.ov2021.config.impl.digester.elements.NamedEvent namedEventConfig = 
                        new org.apache.myfaces.ov2021.config.impl.digester.elements.NamedEvent();
        ...
        if (classes != null && !classes.isEmpty())
        {
            for (Class<?> clazz : classes)
            {
                ...
                if (facesBehaviorRenderer != null) {
                   ...
                   org.apache.myfaces.ov2021.config.impl.digester.elements.ClientBehaviorRenderer cbr = 
                        new org.apache.myfaces.ov2021.config.impl.digester.elements.ClientBehaviorRenderer();
