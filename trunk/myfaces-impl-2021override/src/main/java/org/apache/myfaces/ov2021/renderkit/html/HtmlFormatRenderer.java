...
import org.apache.myfaces.shared_ext202patch.renderkit.html.CommonPropertyConstants;
 ...
 * @version $Revision: 1364637 $ $Date: 2012-07-23 16:00:28 +0200 (Mo, 23 Jul 2012) $
 */
...
public class HtmlFormatRenderer extends HtmlRenderer
{
    ...
    public void encodeEnd(FacesContext facesContext, UIComponent component) throws IOException
    {
        ...
        if (text != null)
        {
            ...
            if(span)
            {
                writer.endElement(org.apache.myfaces.shared_ext202patch.renderkit.html.HTML.SPAN_ELEM);
            }
        }
    }
