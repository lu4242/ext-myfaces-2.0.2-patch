...
public class WebXml
{
    ...
    public List getFacesServletMappings()
    {
        ...
        for (Iterator it = _servlets.entrySet().iterator(); it.hasNext(); )
        {
            ...
            Class servletClass = org.apache.myfaces.shared_ext202patch.util.ClassUtils.simpleClassForName((String)entry.getValue());
                    ...
                    servletClass.getName().equals(_delegateFacesServlet))
            {
                ...
                if( urlPatterns != null )
                {
                    for (Iterator it2 = urlPatterns.iterator(); it2.hasNext(); )
                    {
                        ...
                        tempFacesServletMappings.add(new org.apache.myfaces.ov2021.shared_impl.webapp.webxml.ServletMapping(servletName,
                                                                                                             servletClass,
                                                                                                             urlpattern));
    ...
    public List getFacesExtensionsFilterMappings()
    {
        ...
        for (Iterator it = _filters.entrySet().iterator(); it.hasNext(); )
        {
            ...
            Class filterClass = org.apache.myfaces.shared_ext202patch.util.ClassUtils.simpleClassForName(filterClassName);
            ...
            if( urlPatterns != null )
            {
                ...
                {
                    String urlpattern = (String)it2.next();
                    tempExtensionsFilterMappings.add(new org.apache.myfaces.ov2021.shared_impl.webapp.webxml.FilterMapping(
