...
import org.apache.myfaces.shared_ext202patch.util.ArrayUtils;
 ...
 * @version $Rev: 1296362 $ $Date: 2012-03-02 19:27:53 +0100 (Fr, 02 Mär 2012) $
 */
...
//                    : new HashSet<String>(clientIds);
    ...
    ArrayUtils.addAll(_clientIds, clientIds);
