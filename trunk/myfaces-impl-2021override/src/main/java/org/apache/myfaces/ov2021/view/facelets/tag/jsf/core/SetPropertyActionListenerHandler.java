...
import org.apache.myfaces.ov2021.view.facelets.el.ContextAwareELException;
        ...
        public void processAction(ActionEvent evt) throws AbortProcessingException
        {
            ...
            if (value != null)
            {
                ...
                catch (ELException e)
                {
                    ...
                    // Wrapping of ValueExpressions to org.apache.myfaces.ov2021.view.facelets.el.ContextAware
                    // can be disabled:
